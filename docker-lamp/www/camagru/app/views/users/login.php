...
<div class="box-container text-center">
	...
	<form method='post' action=<?php echo URLROOT . '/users/login'; ?>>
			...
			<input class="form-control <?php echo (!empty($data['name_error']) || !empty($data['email_error'])) ? 'is-invalid' : ''; ?>" type="text" name="user_name/email" value="<?php if (!empty($data['user_name'])) echo $data['user_name']; elseif (!empty($data['email'])) echo $data['email'];?>"><br>
			<span class='invalid-feedback'><?php if(!empty($data['email_error'])) echo $data['email_error']; elseif(!empty($data['name_error'])) echo $data['name_error']; ?></span>
			</div>
			...
			<a href="<?php echo URLROOT . '/users/resetpassword'; ?>" class="btn">Reset password</a>
			</div>
	</form>
</div>
